...
struct VideoStreamWriter
{
   ...
   VidcStatus (*bitstreamWriter)(VideoStreamWriter* pWriter, void* pFile, uint8* pBuffer, uint32 nBytes);
};

VidcStatus VideoStreamWriterInit(VideoStreamWriter* pWriter, uint32 nNalHeaderLength);
