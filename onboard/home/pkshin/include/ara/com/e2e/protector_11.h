...
#ifndef ARA_COM_E2E_PROTECTOR11_H
#define ARA_COM_E2E_PROTECTOR11_H
...
private:
    void WriteDataIdNibbleAndCounter(apd::crc::Buffer& buffer, uint16_t dataId, uint8_t counter) const noexcept;
...
#endif  // ARA_COM_E2E_PROTECTOR11_H
