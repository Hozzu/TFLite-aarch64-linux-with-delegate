...
struct Config
{
    ...
    ara::core::Map<DataIdentifier, std::shared_ptr<ara::com::profile::profile_interface::ProtectorInterface>>
        profileProtectors;
    /// @brief profile checkers associated with data identifiers
    ara::core::Map<DataIdentifier, std::shared_ptr<ara::com::profile::profile_interface::CheckerInterface>>
        profileCheckers;
    /// @brief E2E state machines associated with data identifiers
    ara::core::Map<DataIdentifier, std::shared_ptr<ara::com::e2e::StateMachine>> stateMachines;
};
