...
#ifndef ARA_DDS_BINDING_INCLUDES_LIBARA_INTERNAL_DDS_PROXY_MAKE_METHOD_DESCRIPTOR_FROM_H_
#define ARA_DDS_BINDING_INCLUDES_LIBARA_INTERNAL_DDS_PROXY_MAKE_METHOD_DESCRIPTOR_FROM_H_
...
struct MakeGetMethodDescriptorFrom
{
    ...
    static constexpr types::ServiceVersionMajor service_version = FieldDescriptor::service_version;
...
#endif  // ARA_DDS_BINDING_INCLUDES_LIBARA_INTERNAL_DDS_PROXY_MAKE_METHOD_DESCRIPTOR_FROM_H_
