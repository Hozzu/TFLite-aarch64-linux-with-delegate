...
// Field implementation for Proxy Interface
...
public:
    ...
    // instance_id = InstanceId to create the FieldImpl object
...
protected:
    // This is the get method proxy instance that is used if someone calls Get() on this field.
    // Note: MethodImpl is defined inside wrsomeip_method_impl.h
