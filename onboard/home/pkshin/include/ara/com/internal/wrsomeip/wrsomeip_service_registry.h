...
class WrSomeIPServiceRegistryImpl : public internal::runtime::ServiceRegistry
{
public:
    WrSomeIPServiceRegistryImpl();
...
private:
    struct RegisteredObject
    {
        ...
        ara::com::internal::wrsomeip::types::InstanceId instance_id_;
    };
