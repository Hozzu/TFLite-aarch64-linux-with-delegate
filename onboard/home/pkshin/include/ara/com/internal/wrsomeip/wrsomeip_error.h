...
#include "wrsomeip_types.h"
#include "wrsomeip_marshalling.h"
...
class Enumerator
{
    ara::core::Vector<types::byte_t>& dst_;
...
public:
     ...
     */
    Enumerator(ara::core::Vector<types::byte_t>& dst)
        : dst_(dst)
    { }
    ...
    {
        ara::com::internal::wrsomeip::common::Serializer<T> serializer(value);
        serializer.pushbackTo(dst_);
    }
};

using SerializeFunction
    = std::function<void(const ara::com::ApplicationErrorException& error, ara::core::Vector<types::byte_t>& dst)>;
using DeserializeFunction = std::function<std::exception_ptr(wrapper::WrsomeipPayload& payload)>;
...
public:
     ...
     */
    static void serialize(const ara::com::ApplicationErrorException& error, ara::core::Vector<types::byte_t>& dst);
     ...
     */
    static std::exception_ptr deserialize(std::uint8_t errorCode, wrapper::WrsomeipPayload& payload);
};
