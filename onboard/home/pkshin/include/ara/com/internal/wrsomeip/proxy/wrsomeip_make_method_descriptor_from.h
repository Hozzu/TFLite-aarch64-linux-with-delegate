...
struct MakeGetMethodDescriptorFrom
{
    ...
    static constexpr types::SomeIpMethod method_id = FieldDescriptor::get_method_id;
};
...
struct MakeSetMethodDescriptorFrom
{
    static constexpr types::ServiceId service_id = FieldDescriptor::service_id;
    static constexpr types::ServiceVersionMajor service_version = FieldDescriptor::service_version;
    static constexpr types::SomeIpMethod method_id = FieldDescriptor::set_method_id;
};
