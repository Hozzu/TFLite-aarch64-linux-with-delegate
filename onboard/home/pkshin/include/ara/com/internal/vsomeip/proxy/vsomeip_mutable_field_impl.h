...
#ifndef COMMUNICATIONMIDDLEWARE_PROXY_VSOMEIP_MUTABLE_FIELD_IMPL_H
#define COMMUNICATIONMIDDLEWARE_PROXY_VSOMEIP_MUTABLE_FIELD_IMPL_H
...
#endif  // COMMUNICATIONMIDDLEWARE_PROXY_VSOMEIP_MUTABLE_FIELD_IMPL_H
