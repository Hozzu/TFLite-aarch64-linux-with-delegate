...
/// Enumeration of the color filter pattern for ARGB outputs
enum class ARGBColorFilterPattern
{
    ARGB32_8_8_8_8,       ///< ARGB occupies 8, 8, 8, 8 valid bits, totally 32 bits.
    ARGB32_2_10_10_10,    ///< ARGB occupies 2, 10, 10, 10 valid bits, totally 32 bits.
    ARGB64_14_14_14_14    ///< ARGB occupies 14, 14, 14, 14 valid bits, totally 64bits.
};
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @brief This structure defines the ARGBFormat format.
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
struct ARGBFormat
{
    UINT32                  bitsPerPixel;       ///< Bits per pixel.
    UINT32                  stride;             ///< Stride in bytes.
    UINT32                  sliceHeight;        ///< The number of lines in the plane which can be equal to or larger than
                                                ///< actual frame height.
    ARGBColorFilterPattern  colorFilterPattern; ///< Color filter pattern of the ARGB format.
};
...
union FormatParams
{
    ...
    ARGBFormat  argbFormat;                   ///< ARGB format specific properties.
