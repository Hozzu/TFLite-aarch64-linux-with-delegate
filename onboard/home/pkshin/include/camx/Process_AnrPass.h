...
int32_t ANR_FlowProcessNcLib(
    ...
    IPEANRRegCmd* registerStructPasses,
...
*  @return NC_LIB_SUCCESS in case of success, otherwise failed.
*/
int32_t ANR_ValidateNcLibRegs(IPEANRRegCmd* registerStruct, uint32_t numOfPasses, uint32_t mE);
...
*  @return void
*/
void SetDefaultVal_ANR(IPEANRRegCmd* registerStruct, uint32_t numOfPasses, uint32_t mE);

/**
*  @brief   Clear (set to 0) the register struct for all the passes
*
*  @param [in]      registerStruct      Array of ANR register structures
*  @param [in]      numOfPasses         Number of passes to be cleared, typically 4
*
*  @return void
*/
void Clear_ANR(IPEANRRegCmd* registerStruct, uint32_t numOfPasses);
