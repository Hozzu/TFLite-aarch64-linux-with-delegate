...
static const GrallocUsage64 GrallocUsageProducerVideoNV21Encoder = (1 << 24); ///< Video NV21 Encoder Producer
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
static const UINT MaxInputBuffers           = 25;
static const UINT MaxOutputBuffers          = 25;
...
struct CaptureRequest
{
       ...
       struct CaptureRequest* pSrc)
    {
        ...
        if ((NULL != pDst) && (NULL != pSrc) && (NULL != pDst->pStreamBuffers) && (NULL != pSrc->pStreamBuffers))
        {
            ...
            Utils::Memcpy(pDst->pStreamBuffers, pSrc->pStreamBuffers, (sizeof(StreamBufferInfo) * pSrc->numBatchedFrames));
        }
        else
        {
         ...
         struct CaptureRequest* pData)
    {
        if (NULL != pData)
        {
            ...
            UINT32            numBatchedFrames     = pData->numBatchedFrames;
...
struct FormatParamInfo
{
    ...
    AndroidDataspace  dataspace;                         ///< Dataspace for this buffer
};
