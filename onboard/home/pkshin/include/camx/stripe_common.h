...
/* Scale Down by 4 and Ceil/ Round-up to multiple of 2 */
#ifndef SCALE_DOWN_4_CEIL_2
#define SCALE_DOWN_4_CEIL_2( value ) ((((value) + 7) / 8) * 2)
#endif

/* Floor/ Round Down to multiple of 8 */
#ifndef FLOOR_8
#define FLOOR_8( value ) (((value) / 8) * 8)
#endif

  /* Ceil/ Round Up to multiple of 8 */
#ifndef CEIL_8
#define CEIL_8( value ) ((((value) + 7) / 8) * 8)
#endif
