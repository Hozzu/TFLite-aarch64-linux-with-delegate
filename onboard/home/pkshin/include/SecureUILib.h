 ...
 * This thread can potentially cause some performance gaps. Should be used
 * with caution.
 *
 * @param[in] handle       Handle for the active connection with the secure application.
 * @param[in] command_mtx  mutex to make sure of exclusivity when commands are sent to TA.
 *
 * @return
 * 0 on success; otherwise, errno.
 *
