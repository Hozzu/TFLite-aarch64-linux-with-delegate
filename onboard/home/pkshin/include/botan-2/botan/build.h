...
* 'configure.py --prefix=/home/shan/git/bsp/adcm_bsp_sa8195/sources/apps/apps_proc/poky/build/tmp-glibc/work/aarch64-oe-linux/botan/2.18.1-r0/image/usr --libdir=/home/shan/git/bsp/adcm_bsp_sa8195/sources/apps/apps_proc/poky/build/tmp-glibc/work/aarch64-oe-linux/botan/2.18.1-r0/image/usr/lib --cpu=aarch64 --cc-bin=aarch64-oe-linux-g++ -march=armv8-a -mcpu=cortex-a57 -mtune=cortex-a57 --sysroot=/home/shan/git/bsp/adcm_bsp_sa8195/sources/apps/apps_proc/poky/build/tmp-glibc/work/aarch64-oe-linux/botan/2.18.1-r0/recipe-sysroot --cxxflags= -O2 -fomit-frame-pointer    -Wa,--noexecstack -fexpensive-optimizations   -frename-registers -ftree-vectorize   -finline-functions -finline-limit=64   -Wno-error=maybe-uninitialized -Wno-error=unused-result     -fvisibility-inlines-hidden --ldflags=-Wl,-O1 -Wl,--hash-style=gnu -Wl,--as-needed --with-endian=little --disable-neon --with-sysroot-dir=/home/shan/git/bsp/adcm_bsp_sa8195/sources/apps/apps_proc/poky/build/tmp-glibc/work/aarch64-oe-linux/botan/2.18.1-r0/recipe-sysroot --with-build-dir=/home/shan/git/bsp/adcm_bsp_sa8195/sources/apps/apps_proc/poky/build/tmp-glibc/work/aarch64-oe-linux/botan/2.18.1-r0/Botan-2.18.1 --optimize-for-size --with-stack-protector --enable-shared-library --with-python-versions=3'
*
* Target
*  - Compiler: aarch64-oe-linux-g++ -march=armv8-a -mcpu=cortex-a57 -mtune=cortex-a57 --sysroot=/home/shan/git/bsp/adcm_bsp_sa8195/sources/apps/apps_proc/poky/build/tmp-glibc/work/aarch64-oe-linux/botan/2.18.1-r0/recipe-sysroot -pthread -std=c++11 -D_REENTRANT  -O2 -fomit-frame-pointer    -Wa,--noexecstack -fexpensive-optimizations   -frename-registers -ftree-vectorize   -finline-functions -finline-limit=64   -Wno-error=maybe-uninitialized -Wno-error=unused-result     -fvisibility-inlines-hidden
*  - Arch: arm64
*  - OS: linux
*/
...
#define BOTAN_INSTALL_PREFIX R"(/home/shan/git/bsp/adcm_bsp_sa8195/sources/apps/apps_proc/poky/build/tmp-glibc/work/aarch64-oe-linux/botan/2.18.1-r0/image/usr)"
#define BOTAN_INSTALL_HEADER_DIR R"(include/botan-2)"
#define BOTAN_INSTALL_LIB_DIR R"(/home/shan/git/bsp/adcm_bsp_sa8195/sources/apps/apps_proc/poky/build/tmp-glibc/work/aarch64-oe-linux/botan/2.18.1-r0/image/usr/lib)"
