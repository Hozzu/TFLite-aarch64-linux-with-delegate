/******************************************************************************
  ...
  ---------------------------------------------------------------------------
  Copyright (c) 2007-2010,2012,2017 Qualcomm Technologies, Inc.
  All Rights Reserved.
  Confidential and Proprietary - Qualcomm Technologies, Inc.
  ---------------------------------------------------------------------------
*******************************************************************************/
#ifndef DATA_QMI_CLIENT_LEGACY_H
#define DATA_QMI_CLIENT_LEGACY_H
...
#endif
/*===========================================================================
  FUNCTION  qcci_legacy_qmi_client_init
===========================================================================*/
/*!
@brief
...
/*===========================================================================
  FUNCTION  qcci_legacy_qmi_client_send_raw_msg_async
===========================================================================*/
/*!
@brief
...
/*=========================================================================*/
extern qmi_client_error_type
qcci_legacy_qmi_client_send_raw_msg_async
(
  qmi_client_type                   user_handle,
  unsigned long                     msg_id,
  void                              *req_buf,
...
/*===========================================================================
  FUNCTION  qcci_legacy_qmi_client_send_msg_async
===========================================================================*/
/*!
@brief
  Sends an asynchronous QMI service message on the specified connection.
...
qcci_legacy_qmi_client_send_msg_async
(
    qmi_client_type                 user_handle,
    unsigned long                   msg_id,
    void                            *req_c_struct,
...
/*=========================================================================*/
extern qmi_client_error_type
qcci_legacy_qmi_client_delete_async_txn
(
  qmi_client_type  user_handle,
...
/*===========================================================================
  FUNCTION  qcci_legacy_qmi_client_send_raw_msg_sync
===========================================================================*/
/*!
@brief
...
/*=========================================================================*/
extern qmi_client_error_type
qcci_legacy_qmi_client_send_raw_msg_sync
(
  qmi_client_type           user_handle,
  unsigned long             msg_id,
  void                      *req_buf,
...
/*===========================================================================
  FUNCTION  qcci_legacy_qmi_client_send_msg_sync
===========================================================================*/
/*!
@brief
  Sends a synchronous QMI service message on the specified connection.
...
/*=========================================================================*/
extern qmi_client_error_type
qcci_legacy_qmi_client_send_msg_sync
(
    qmi_client_type    user_handle,
    int                msg_id,
    void               *req_c_struct,
...
/*===========================================================================
  FUNCTION  qcci_legacy_qmi_client_release
===========================================================================*/
/*!
@brief
...
/*=========================================================================*/
extern qmi_client_error_type
qcci_legacy_qmi_client_release
(
  qmi_client_type     user_handle
);
...
/*===========================================================================
  FUNCTION  qcci_legacy_qmi_client_message_encode
===========================================================================*/
/*!
@brief
...
/*=========================================================================*/
extern qmi_client_error_type
qcci_legacy_qmi_client_message_encode
(
    qmi_client_type                      user_handle,
...
/*===========================================================================
  FUNCTION  qcci_legacy_qmi_client_message_decode
===========================================================================*/
/*!
@brief
...
/*=========================================================================*/
extern qmi_client_error_type
qcci_legacy_qmi_client_message_decode
(
    qmi_client_type                         user_handle,
    qmi_idl_type_of_message_type            req_resp_ind,
    int                                     message_id,
...
/*===========================================================================
  FUNCTION  qcci_legacy_qmi_client_get_service_version
===========================================================================*/
/*!
@brief 
...
qmi_client_error_type
qcci_legacy_qmi_client_get_service_version
(
    const char                   *conn_id,
...
#endif /* DATA_QMI_CLIENT_LEGACY_H */
