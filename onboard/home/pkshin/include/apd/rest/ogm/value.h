...
#ifndef LIB_APDREST_INCLUDE_APD_REST_OGM_VALUE_H_
#define LIB_APDREST_INCLUDE_APD_REST_OGM_VALUE_H_
 ...
 * \uptrace{SWS_REST_02152}
 */
class Value
    : public Node
    , public Base<Value, Node, false>
{
...
protected:
     ...
     * \brief constructor
     */
    explicit Value(NodeType type) noexcept
        : Node(nullptr, type)
    { }  // note the 'nullptr' here

    /**
     * \brief constructor
     */
    explicit Value(Allocator* alloc, NodeType type) noexcept
        : Node(alloc, type)
    { }
};
...
#endif  // LIB_APDREST_INCLUDE_APD_REST_OGM_VALUE_H_
