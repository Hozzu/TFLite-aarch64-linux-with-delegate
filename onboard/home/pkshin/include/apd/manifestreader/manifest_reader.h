...
#ifndef APD_MANIFESTREADER_MANIFEST_READER_H_
#define APD_MANIFESTREADER_MANIFEST_READER_H_

#include "apd/manifestreader/manifest.h"
...
#endif  // APD_MANIFESTREADER_MANIFEST_READER_H_
